 ...
 */
export declare const getVerifiableCertificates: (wallet: WalletInterface, requestedCertificates: RequestedCertificateSet, verifierIdentityKey: string) => Promise<VerifiableCertificate[]>;
